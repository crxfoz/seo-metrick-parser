...
// GetTasksBadGatewayCode is the HTTP code returned for type GetTasksBadGateway
const GetTasksBadGatewayCode int = 502

/*GetTasksBadGateway Database is down

swagger:response getTasksBadGateway
*/
type GetTasksBadGateway struct {
}

// NewGetTasksBadGateway creates GetTasksBadGateway with default headers values
func NewGetTasksBadGateway() *GetTasksBadGateway {

	return &GetTasksBadGateway{}
}

// WriteResponse to the client
func (o *GetTasksBadGateway) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
